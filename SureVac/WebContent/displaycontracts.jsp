			...
			<div class="col-md-2">
				<div id="side-bar">
					<ul class="nav">
						...
						<li class="active"><a href="displayproducts.jsp"><i class="glyphicon">ListProduct's</i></a></li>
						...
						<li><a href="displaycontracts.jsp"><i class="glyphicon ">displayContract</i></a></li>
							...
							<div class="center">
								<center>
									<div class="our-logo col-md-4 col-md-offset-4">
										<h2 style="color: crimson">CONTRACTS</h2>
							...
							<p>
								<c:forEach var="user" items="${list1.rows}">
									<tr>
										...
										<td><br> <c:out value="${user.cdesc}" /></td>
										<td><br> <c:out value="${user.startdate}" /></td>
										<td><br> <c:out value="${user.wrntyprd}" /></td>
										<td><br> <a
											href="DeleteContractServlet?id=<c:out value="${user.pcode}"/>">Delete</a></td>
									</tr>
								</c:forEach>
							</p>
						</tbody>
