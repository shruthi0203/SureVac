  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   <script > 
    ...
    function validate() {
        ...
        if (form1.Mobile Number.value == '') {
            isValid = false;
        }
        if (form1.Pin code.value == '') {
            isValid = false;
        }
...
<%@include file="all.jsp" %>
				...
				<div class="row clearfix">   
					<div class=" wrap-buynow col-md-6 col-sm-12 col-md-offset-4">	
						...
						<form1 action="buynow" method="Post">
					<div class="form-group">
						<label for="">Name</label> <input type="text" name="Name"
							class="form-control" id="" placeholder="Name" required>
					</div>
					<div class="form-group">
						<label for="">Phone</label> <input type="number" name="Mobile Number"
							class="form-control" id="" placeholder="Number" required>
					</div>
					<div class="form-group">
						<label for="">Pin code</label> <input type="code" name="Pin code"
...
<form2>
    <div class="radio">
      <label><input type="radio" value="1" name="formselector" onClick="displayForm(this)">Credit card</label>
      ...
      <div style="visibility:hidden;  position:relative" id="ccformContainer">
        <form id="ccform">                  
                <p>Credit Card Name :
                    <input type="text" id="ccname" name="ccname" value="$ccname" required>
                </p>
                <p>Credit Card Type :
                    ...
                    <p>Credit Card Number :
                        <input type="text" minlength="16" id="ccnumber" name="ccnumber" value="$ccnumber" required>
                    </p>
                    ...
                    <option value="2021">2021</option>
                        ...
                        <p>Credit Card CVC :
                            <input type="text" minlength="3" id="cccvc" name="cccvc" value="$cccvc" required>
                        </p>
