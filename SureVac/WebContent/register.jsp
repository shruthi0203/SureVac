           ...
           <h2 style="margin-top: 30px"> Register Here... </h2>
            <form action="register" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="Fname" class="form-control" id="First Name" placeholder="First Name"  data-rule="fname" required>
                </div>
                <div class="form-group">
                    <label for="">Last Name</label>
                    <input type="text" name="Lname" class="form-control" id="last Name" placeholder="last Name" data-rule="lname" required>
                </div>
                <div class="form-group">
                 <label for="">Email</label>
                   <input type="text" name="Email" class="form-control"  id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" required/>
                    </div>        
                
                 <div class="form-group">
                    <label for="">Username</label>
                    <input type="text" name="UserName" class="form-control" id="Username" placeholder="Username" data-rule="username" required>
                </div>
                <div class="form-group">
                    <label for="">Password</label>
                    <input type="text" name="Password" class="form-control" id="Password" placeholder="Password" data-rule="password" required>
